...
gl_eye_tracking3_CPPFLAGS=-I$(gl_eye_tracking3_BASE)/src/ -I$(MLSDK)/include -DML_DEVICE -DML_DEFAULT_LOG_TAG=\"gl_eye_tracking2\"
...
$(gl_eye_tracking3_OUTPUT)/obj.gl_eye_tracking3/src/RBPoint.cpp.o : $(gl_eye_tracking3_BASE)/src/RBPoint.cpp $(gl_eye_tracking3_BASE)/gl_eye_tracking3.mabu $(MLSDK)/.metadata/components/ml_sdk.comp $(MLSDK)/.metadata/components/ml_sdk_common.comp $(MLSDK)/tools/mabu/data/components/OpenGL.comp $(MLSDK)/tools/mabu/data/components/stdc++.comp $(MLSDK)/tools/mabu/data/configs/debug.config $(MLSDK)/tools/mabu/data/options/debug/on.option $(MLSDK)/tools/mabu/data/options/exceptions/on.option $(MLSDK)/tools/mabu/data/options/magicleap.option $(MLSDK)/tools/mabu/data/options/optimize/off.option $(MLSDK)/tools/mabu/data/options/package/debuggable/on.option $(MLSDK)/tools/mabu/data/options/runtime/shared.option $(MLSDK)/tools/mabu/data/options/standard-c++/17.option $(MLSDK)/tools/mabu/data/options/warn/on.option C:/lcb/Learnings/ML/gl_eye_tracking3/samples_common.comp
	$(INFO) \[gl_eye_tracking3\]\ Compiling\ 'RBPoint.cpp'...
	$(ECHO) $(COMPILER_PREFIX) $(CXX) -c $(gl_eye_tracking3_BASE)/src/RBPoint.cpp -o $(gl_eye_tracking3_OUTPUT)/obj.gl_eye_tracking3/src/RBPoint.cpp.o -MD -MP -MF $(gl_eye_tracking3_OUTPUT)/obj.gl_eye_tracking3/src/RBPoint.cpp.d $(gl_eye_tracking3_CPPFLAGS) $(gl_eye_tracking3_CXXFLAGS)
	$(ECHO) echo $(gl_eye_tracking3_BASE)/src/RBPoint.cpp : >> $(gl_eye_tracking3_OUTPUT)/obj.gl_eye_tracking3/src/RBPoint.cpp.d

-include $(gl_eye_tracking3_OUTPUT)/obj.gl_eye_tracking3/src/RBPoint.cpp.d
...
gl_eye_tracking3-clean :: 
	...
	$(ECHO) $(RM) -rf $(gl_eye_tracking3_OUTPUT)/obj.gl_eye_tracking3/src/RBCube.cpp.o $(gl_eye_tracking3_OUTPUT)/obj.gl_eye_tracking3/src/RBCube.cpp.d $(gl_eye_tracking3_OUTPUT)/obj.gl_eye_tracking3/src/RBPoint.cpp.o $(gl_eye_tracking3_OUTPUT)/obj.gl_eye_tracking3/src/RBPoint.cpp.d $(gl_eye_tracking3_OUTPUT)/bin/libc++_shared.so
	$(ECHO) $(RM) -rf $(gl_eye_tracking3_OUTPUT)/data/res/cloud/depth_data.txt $(gl_eye_tracking3_OUTPUT)/data/res/cloud/depth_data.zip $(gl_eye_tracking3_OUTPUT)/data/res/shaders/basic.frag $(gl_eye_tracking3_OUTPUT)/data/res/shaders/basic3D.vert $(gl_eye_tracking3_OUTPUT)/data/res/shaders/standard.frag
	$(ECHO) $(RM) -rf $(gl_eye_tracking3_OUTPUT)/data/res/shaders/standard3D.vert $(gl_eye_tracking3_OUTPUT)/data/res/shaders/texture.frag $(gl_eye_tracking3_OUTPUT)/data/res/shaders/texture.vert $(gl_eye_tracking3_OUTPUT)/data/res/texture/container.jpg
