...
gl_eye_tracking3-clean :: 
	...
	$(ECHO) $(RM) -rf $(gl_eye_tracking3_OUTPUT)/data/res/cloud/depth_data.zip $(gl_eye_tracking3_OUTPUT)/data/res/cloud/depth_data_0.txt $(gl_eye_tracking3_OUTPUT)/data/res/cloud/depth_data_1.txt $(gl_eye_tracking3_OUTPUT)/data/res/cloud/depth_data_2.txt $(gl_eye_tracking3_OUTPUT)/data/res/cloud/depth_data_3.txt
	$(ECHO) $(RM) -rf $(gl_eye_tracking3_OUTPUT)/data/res/cloud/depth_data_4.txt $(gl_eye_tracking3_OUTPUT)/data/res/shaders/basic.frag $(gl_eye_tracking3_OUTPUT)/data/res/shaders/basic3D.vert $(gl_eye_tracking3_OUTPUT)/data/res/shaders/standard.frag $(gl_eye_tracking3_OUTPUT)/data/res/shaders/standard3D.vert
	$(ECHO) $(RM) -rf $(gl_eye_tracking3_OUTPUT)/data/res/shaders/texture.frag $(gl_eye_tracking3_OUTPUT)/data/res/shaders/texture.vert $(gl_eye_tracking3_OUTPUT)/data/res/texture/container.jpg
