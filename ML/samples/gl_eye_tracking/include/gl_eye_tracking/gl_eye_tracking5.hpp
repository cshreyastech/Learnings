...
private:
  std::shared_ptr<ml::app_framework::Node> cube_node1_;
  std::shared_ptr<ml::app_framework::Node> cube_node2_;
  std::shared_ptr<ml::app_framework::Node> cube_node3_;
  std::shared_ptr<ml::app_framework::Node> cube_node4_;
  std::shared_ptr<ml::app_framework::Node> cube_node5_;
  std::shared_ptr<ml::app_framework::Node> cube_node6_;
  std::shared_ptr<ml::app_framework::Node> cube_node7_;
  std::shared_ptr<ml::app_framework::Node> cube_node8_;
};
