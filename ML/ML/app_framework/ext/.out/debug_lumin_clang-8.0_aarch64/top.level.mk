...
glad_BASE=C:/lcb/Learnings/ML/ML/app_framework/ext
...
clean :: glad-clean app_framework-clean ros_ml_server-clean
...
C:/lcb/Learnings/ML/ML/app_framework/ext/assimp.comp : 

C:/lcb/Learnings/ML/ML/app_framework/ext/gflags.comp : 
...
-make-directories : C:/lcb/Learnings/ML/ML/app_framework/.out/debug_lumin_clang-8.0_aarch64 C:/lcb/Learnings/ML/ML/app_framework/.out/debug_lumin_clang-8.0_aarch64/bin C:/lcb/Learnings/ML/ML/app_framework/ext/.out/debug_lumin_clang-8.0_aarch64 C:/lcb/Learnings/ML/ML/app_framework/ext/.out/debug_lumin_clang-8.0_aarch64/bin C:/lcb/Learnings/ML/ML/app_framework/ext/.out/debug_lumin_clang-8.0_aarch64/obj.glad/glad/src C:/lcb/Learnings/ML/ML/ml_apps/BUILD/debug_lumin_clang-8.0_aarch64 C:/lcb/Learnings/ML/ML/ml_apps/BUILD/debug_lumin_clang-8.0_aarch64/bin C:/lcb/Learnings/ML/ML/ml_apps/BUILD/debug_lumin_clang-8.0_aarch64/data/res/cloud C:/lcb/Learnings/ML/ML/ml_apps/BUILD/debug_lumin_clang-8.0_aarch64/data/res/shaders C:/lcb/Learnings/ML/ML/ml_apps/BUILD/debug_lumin_clang-8.0_aarch64/obj.ros_ml_server/src/core C:/lcb/Learnings/ML/ML/ml_apps/BUILD/debug_lumin_clang-8.0_aarch64/obj.ros_ml_server/src/render C:/lcb/Learnings/ML/ML/ml_apps/BUILD/debug_lumin_clang-8.0_aarch64/obj.ros_ml_server/src/ros_ml_server
...
C:/lcb/Learnings/ML/ML/app_framework/ext/.out/debug_lumin_clang-8.0_aarch64/obj.glad/glad/src : 
	$(ECHO) @mkdir -p C:/lcb/Learnings/ML/ML/app_framework/ext/.out/debug_lumin_clang-8.0_aarch64/obj.glad/glad/src
...
C:/lcb/Learnings/ML/ML/ml_apps/BUILD/debug_lumin_clang-8.0_aarch64/data/res/shaders : 
	$(ECHO) @mkdir -p C:/lcb/Learnings/ML/ML/ml_apps/BUILD/debug_lumin_clang-8.0_aarch64/data/res/shaders

C:/lcb/Learnings/ML/ML/ml_apps/BUILD/debug_lumin_clang-8.0_aarch64/obj.ros_ml_server/src/core : 
	$(ECHO) @mkdir -p C:/lcb/Learnings/ML/ML/ml_apps/BUILD/debug_lumin_clang-8.0_aarch64/obj.ros_ml_server/src/core

C:/lcb/Learnings/ML/ML/ml_apps/BUILD/debug_lumin_clang-8.0_aarch64/obj.ros_ml_server/src/render : 
	$(ECHO) @mkdir -p C:/lcb/Learnings/ML/ML/ml_apps/BUILD/debug_lumin_clang-8.0_aarch64/obj.ros_ml_server/src/render

C:/lcb/Learnings/ML/ML/ml_apps/BUILD/debug_lumin_clang-8.0_aarch64/obj.ros_ml_server/src/ros_ml_server : 
	$(ECHO) @mkdir -p C:/lcb/Learnings/ML/ML/ml_apps/BUILD/debug_lumin_clang-8.0_aarch64/obj.ros_ml_server/src/ros_ml_server

include $(glad_OUTPUT)/glad.mk
include $(app_framework_OUTPUT)/app_framework.mk
include $(ros_ml_server_OUTPUT)/ros_ml_server.mk
build :  | glad-all app_framework-all ros_ml_server-all
