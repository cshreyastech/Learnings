...
TOUCH=touch
stb_ARFLAGS=
stb_BASE=C:/lcb/AutoECMControl/ML/app_framework/ext
stb_CPPFLAGS=-I$(stb_BASE)/repos/stb-master/ -DML_LUMIN
...
$(stb_OUTPUT)/libstb.a : $(stb_OUTPUT)/obj.stb/stb_lib/stblib.cpp.o $(stb_BASE)/stb.mabu $(MLSDK)/tools/mabu/data/components/stdc++.comp $(MLSDK)/tools/mabu/data/configs/debug.config $(MLSDK)/tools/mabu/data/options/debug/on.option $(MLSDK)/tools/mabu/data/options/magicleap.option $(MLSDK)/tools/mabu/data/options/optimize/off.option $(MLSDK)/tools/mabu/data/options/package/debuggable/on.option $(MLSDK)/tools/mabu/data/options/runtime/shared.option $(MLSDK)/tools/mabu/data/options/warn/on.option C:/lcb/AutoECMControl/ML/app_framework/common.comp
...
$(stb_OUTPUT)/obj.stb/stb_lib/stblib.cpp.o : $(stb_BASE)/stb_lib/stblib.cpp $(stb_BASE)/stb.mabu $(MLSDK)/tools/mabu/data/components/stdc++.comp $(MLSDK)/tools/mabu/data/configs/debug.config $(MLSDK)/tools/mabu/data/options/debug/on.option $(MLSDK)/tools/mabu/data/options/magicleap.option $(MLSDK)/tools/mabu/data/options/optimize/off.option $(MLSDK)/tools/mabu/data/options/package/debuggable/on.option $(MLSDK)/tools/mabu/data/options/runtime/shared.option $(MLSDK)/tools/mabu/data/options/warn/on.option C:/lcb/AutoECMControl/ML/app_framework/common.comp
