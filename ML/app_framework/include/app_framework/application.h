...
enum class ApplicationStatus {
  ...
  Paused,  /**< Paused */
  Running,  /**< Running */
  DeviceStandby,  /**< Device in standby mode */
  DeviceReality,  /**< Device in reality mode */
...
protected:
  ...
  virtual void OnDeviceStandby() {}
  virtual void OnDeviceReality() {}
  virtual void OnDeviceActive() {}
  virtual void OnStop() {}
