...
gl_eye_tracking2_CPPFLAGS=-I$(gl_eye_tracking2_BASE)/src/ -I$(stb_BASE)/stb-master/ -I$(glad_BASE)/glad/include -I$(MLSDK)/include -DML_LUMIN -DML_DEVICE -DML_DEFAULT_LOG_TAG=\"gl_eye_tracking2\"
...
gl_eye_tracking2_LIBS=-L$(MLSDK)/lib/lumin -Wl,--start-group -Bstatic -Wl,--no-as-needed $(stb_OUTPUT)/libstb.a $(glad_OUTPUT)/libglad.a -Bdynamic -lc -lc++_shared -landroid_support -lml_graphics -lml_perception_client -lml_input -lml_lifecycle -lml_ext_logging -lEGL -lGLESv2 -lGLESv3 -lm -Wl,--end-group
...
$(gl_eye_tracking2_OUTPUT)/obj.gl_eye_tracking2/src/RBPoint.cpp.o : $(gl_eye_tracking2_BASE)/src/RBPoint.cpp $(gl_eye_tracking2_BASE)/gl_eye_tracking2.mabu $(MLSDK)/.metadata/components/ml_sdk.comp $(MLSDK)/.metadata/components/ml_sdk_common.comp $(MLSDK)/tools/mabu/data/components/OpenGL.comp $(MLSDK)/tools/mabu/data/components/stdc++.comp $(MLSDK)/tools/mabu/data/configs/debug.config $(MLSDK)/tools/mabu/data/options/debug/on.option $(MLSDK)/tools/mabu/data/options/exceptions/on.option $(MLSDK)/tools/mabu/data/options/magicleap.option $(MLSDK)/tools/mabu/data/options/optimize/off.option $(MLSDK)/tools/mabu/data/options/package/debuggable/on.option $(MLSDK)/tools/mabu/data/options/runtime/shared.option $(MLSDK)/tools/mabu/data/options/standard-c++/17.option $(MLSDK)/tools/mabu/data/options/warn/on.option C:/lcb/Learnings/ML/gl_eye_tracking2/samples_common.comp
	$(INFO) \[gl_eye_tracking2\]\ Compiling\ 'RBPoint.cpp'...
	$(ECHO) $(COMPILER_PREFIX) $(CXX) -c $(gl_eye_tracking2_BASE)/src/RBPoint.cpp -o $(gl_eye_tracking2_OUTPUT)/obj.gl_eye_tracking2/src/RBPoint.cpp.o -MD -MP -MF $(gl_eye_tracking2_OUTPUT)/obj.gl_eye_tracking2/src/RBPoint.cpp.d $(gl_eye_tracking2_CPPFLAGS) $(gl_eye_tracking2_CXXFLAGS)
	$(ECHO) echo $(gl_eye_tracking2_BASE)/src/RBPoint.cpp : >> $(gl_eye_tracking2_OUTPUT)/obj.gl_eye_tracking2/src/RBPoint.cpp.d

-include $(gl_eye_tracking2_OUTPUT)/obj.gl_eye_tracking2/src/RBPoint.cpp.d
...
gl_eye_tracking2-clean :: 
	...
	$(ECHO) $(RM) -rf $(gl_eye_tracking2_OUTPUT)/obj.gl_eye_tracking2/src/RBTexture.cpp.d $(gl_eye_tracking2_OUTPUT)/bin/libc++_shared.so $(gl_eye_tracking2_OUTPUT)/data/res/shaders/standard.frag $(gl_eye_tracking2_OUTPUT)/data/res/shaders/standard3D.vert $(gl_eye_tracking2_OUTPUT)/data/res/shaders/texture.frag
