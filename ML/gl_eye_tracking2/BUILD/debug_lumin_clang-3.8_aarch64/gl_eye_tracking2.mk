...
gl_eye_tracking2_CPPFLAGS=-I$(gl_eye_tracking2_BASE)/src/ -I$(glad_BASE)/glad/include -I$(stb_BASE)/stb-master/ -I$(MLSDK)/include -DML_LUMIN -DML_DEVICE -DML_DEFAULT_LOG_TAG=\"gl_eye_tracking2\"
...
gl_eye_tracking2_LIBS=-L$(MLSDK)/lib/lumin -Wl,--start-group -Bstatic -Wl,--no-as-needed $(glad_OUTPUT)/libglad.a $(stb_OUTPUT)/libstb.a -Bdynamic -lc -lc++_shared -landroid_support -lml_graphics -lml_perception_client -lml_input -lml_lifecycle -lml_ext_logging -lEGL -lGLESv2 -lGLESv3 -lm -Wl,--end-group
...
gl_eye_tracking2-clean :: 
	...
	$(ECHO) $(RM) -rf $(gl_eye_tracking2_OUTPUT)/obj.gl_eye_tracking2/src/RBTexture.cpp.d $(gl_eye_tracking2_OUTPUT)/bin/libc++_shared.so $(gl_eye_tracking2_OUTPUT)/data/res/shaders/basic.frag $(gl_eye_tracking2_OUTPUT)/data/res/shaders/basic3D.vert $(gl_eye_tracking2_OUTPUT)/data/res/shaders/standard.frag
