...
int main()
{
  ...
  // ------------------------------------
  Shader ourShader("../src/res/shaders/04-Textures/4.4.shader.vs", "../src/res/shaders/04-Textures/4.4.shader.fs");
  ...
  int i = 0;
  std::string texture_path = "../src/res/texture/container.jpg";
  // render loop
  // -----------
